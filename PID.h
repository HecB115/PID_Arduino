...
class PID{
  ...
  void PID::limits(double minValue, double maxValue); /*The default limit of the PID value is between 0 and 255
  if you want to change them to whatever you want, use this fucntion */

  void PID::kValues(double KP, double KI, double KD); //If you want to change your current Kp , Ki and Kd values, use this fucntion
